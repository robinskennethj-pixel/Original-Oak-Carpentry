import { Hammer, Facebook, Instagram, Linkedin, Mail, Phone, MapPin } from "lucide-react"
        ...
        <div className="grid md:grid-cols-4 gap-8">
          <div className="space-y-6">
            ...
            <p className="text-sm opacity-80 leading-relaxed">
              Master craftsmen forging exceptional woodwork and metal fabrication with traditional techniques 
              and modern precision. Where artistry meets durability.
            </p>
            <div className="flex items-center gap-4">
              <a href="https://facebook.com/oguncarpentry" target="_blank" rel="noopener noreferrer">
                <Facebook className="h-5 w-5 opacity-60 hover:opacity-100 cursor-pointer transition-opacity hover:text-accent" />
              </a>
              <a href="https://instagram.com/oguncarpentry" target="_blank" rel="noopener noreferrer">
                <Instagram className="h-5 w-5 opacity-60 hover:opacity-100 cursor-pointer transition-opacity hover:text-accent" />
              </a>
              <a href="https://linkedin.com/company/oguncarpentry" target="_blank" rel="noopener noreferrer">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm opacity-80">
              <li>
                <Link href="/services/custom-woodwork" className="hover:opacity-100 hover:text-accent transition-all duration-300">
                  Custom Woodwork
                </Link>
              </li>
              <li>
                <Link href="/services/metal-fabrication" className="hover:opacity-100 hover:text-accent transition-all duration-300">
                  Metal Fabrication
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/services/sustainable-crafting" className="hover:opacity-100 hover:text-accent transition-all duration-300">
                  Sustainable Crafting
                </Link>
              </li>
              <li>
                <Link href="/services/bespoke-commissions" className="hover:opacity-100 hover:text-accent transition-all duration-300">
                  Bespoke Commissions
                </Link>
              </li>
            </ul>
