...
const testimonials = [
  {
    ...
    content: "Ogun Carpentry restored my great-grandfather's armoire to perfection. The traditional techniques they used brought it back to life better than I ever imagined.",
    rating: 5,
  ...
  },
  {
    ...
    content: "The custom metal gates they forged for our restaurant entrance are absolutely stunning. Every detail shows the master craftsman's touch.",
    rating: 5,
    image: "/happy-homeowner-woman.jpg",
    project: "Custom Restaurant Gates",
  ...
  },
  {
    ...
    content: "Working with Ogun Carpentry is like collaborating with artists. Their ability to translate vision into reality is truly remarkable.",
    rating: 5,
  ...
  },
  {
    ...
    content: "The custom metal railings they created for our home are both beautiful and functional. The attention to detail is incredible.",
    rating: 5,
    image: "/satisfied-couple-homeowners.jpg",
    project: "Custom Metal Railings",
