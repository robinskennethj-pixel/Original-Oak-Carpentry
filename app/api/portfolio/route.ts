...
const portfolioItems = [
  {
    ...
    description: "Solid oak dining table with traditional joinery and hand-carved wooden details",
    image: "/modern-custom-kitchen-with-wooden-cabinets-and-gra.jpg",
    featured: true,
    completedAt: "2024-01-15",
    client: "Marcus Williams",
    location: "Downtown Residence",
    materials: ["Solid Oak", "Hand-carved Details", "Traditional Joinery"],
    techniques: ["Hand-carved Details", "Mortise and Tenon", "Traditional Joinery"],
  },
  {
    id: 2,
    title: "Weather-Resistant Wooden Gates",
    category: "Outdoor Carpentry",
    description: "Custom entrance gates crafted from weather-resistant wood with traditional joinery",
    image: "/elegant-restaurant-interior-with-custom-wooden-fix.jpg",
    featured: true,
    completedAt: "2024-02-20",
    client: "Aisha Johnson",
    location: "Restaurant Entrance",
    materials: ["Weather-Resistant Wood", "Traditional Joinery", "Protective Hardware"],
    techniques: ["Traditional Joinery", "Weather Sealing", "Custom Design"],
  },
  {
    id: 3,
