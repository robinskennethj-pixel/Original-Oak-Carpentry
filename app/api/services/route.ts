...
const services = [
  ...
  },
  {
    ...
    duration: "1-6 weeks",
    featured: true,
    images: ["/elegant-restaurant-interior-with-custom-wooden-fix.jpg"],
    materials: ["Steel", "Iron", "Custom Hardware", "Protective Finishes"],
    techniques: ["Traditional Forging", "Welding", "Custom Design", "Precision Fabrication"],
  },
  {
    id: 3,
